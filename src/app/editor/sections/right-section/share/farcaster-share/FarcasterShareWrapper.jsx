						...
						<Tabs className="overflow-scroll my-2" value={farcasterTab}>
							...
							<>
								<TabsHeader className="relative top-0 ">
									<Tab value={'normalPost'} className="appFont" onClick={() => setFarcasterTab('normalPost')}>
										{' '}
										Quick Share{' '}
									</Tab>
									{!isMobile && (
										<Tab value={'smartPost'} className="appFont" onClick={() => setFarcasterTab('smartPost')}>
											{' '}
											Smart Post{' '}
										</Tab>
									)}
									{isMobile && (
										<Tab value={'erc1155'} className="appFont" onClick={() => setFarcasterTab('erc1155')}>
											{' '}
											Open Edition{' '}
										</Tab>
									)}
