			...
			<SharePanelHeaders
				...
				panelContent={
					<>
						<div className="mb-4 mt-4">
							<div className="flex justify-between">
								...
								<Switch
									...
									className={`${
										solanaEnabled.isChargeForMint ? 'bg-[#e1f16b]' : 'bg-gray-200'
								...
								>
									<span
										className={`${
											solanaEnabled.isChargeForMint ? 'translate-x-6' : 'translate-x-1'
						...
						<div className="mb-4 mt-4">
							<div className="flex justify-between">
								...
								<Switch
									...
									className={`${
										solanaEnabled.isSellerFeeBasisPoints ? 'bg-[#e1f16b]' : 'bg-gray-200'
									} relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#e1f16b] focus:ring-offset-2`}
								>
									<span
										className={`${
											solanaEnabled.isSellerFeeBasisPoints ? 'translate-x-6' : 'translate-x-1'
										} inline-block h-4 w-4 transform rounded-full bg-white transition-transform`}
									/>{' '}
								</Switch>
							</div>
						...
						<div className={`${!solanaEnabled.isSellerFeeBasisPoints && 'hidden'}`}>
							<div className="flex flex-col w-full py-2">
								{/* <label htmlFor="price">Collect limit</label> */}
								<InputBox label="Seller Fees" name="sellerFeeBasisPoints" onChange={(e) => handleChange(e)} value={solanaEnabled.sellerFeeBasisPoints} />
						...
						<div className="mb-4 mt-4">
							<div className="flex justify-between">
								...
								<Switch
									...
									className={`${
										solanaEnabled.isLimitedEdition ? 'bg-[#e1f16b]' : 'bg-gray-200'
									} relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#e1f16b] focus:ring-offset-2`}
								>
									<span
										className={`${
											solanaEnabled.isLimitedEdition ? 'translate-x-6' : 'translate-x-1'
										} inline-block h-4 w-4 transform rounded-full bg-white transition-transform`}
									/>{' '}
								</Switch>
							</div>
						...
						<div className={`${!solanaEnabled.isAllowlist && 'hidden'} `}>
									...
									<>
										<div key={index} className="flex justify-between gap-2 items-center w-full py-2">
											...
											<div className="flex justify-between items-center">
												{index != 0 && (
													<TiDelete className="h-6 w-6 cursor-pointer" color="red" onClick={() => removeArrlistInputBox(index, 'allowlistAddresses')} />
												)}
											</div>
										</div>
									</>
						...
						<div className={`${!solanaEnabled.isNftBurnable && 'hidden'} `}>
											...
											<div className="flex justify-between items-center">
												{index != 0 && (
													<TiDelete
														...
														color="red"
														onClick={() => removeArrlistInputBox(index, 'nftBurnableContractAddresses')}
													/>
												)}
											</div>
										</div>
						...
						<div className={`${!solanaEnabled.isNftGate && 'hidden'} `}>
									...
									<>
										<div key={index} className="flex justify-between gap-2 items-center w-full py-2">
											<InputBox
												label="Contract Address"
												value={recipient}
												onChange={(e) => handleArrlistChange(index, e.target.value, 'nftGateContractAddresses')}
											/>
						...
						<div className={`${!solanaEnabled.isTokenGate && 'hidden'} `}>
						...
						{getSolanaAuth ? (
							<div className="flex flex-col gap-2">
								<Button
									...
									// color="yellow"
									className="mx-0 bg-[#e1f16b] text-black"
								>
									{' '}
									Mint as cNFT{' '}
								</Button>
