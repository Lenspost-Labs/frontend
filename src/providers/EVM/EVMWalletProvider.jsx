...
import { campNetworkTestnetV2, storyMainnet, storyAeneidTestnet, ham, og } from '../../data'

import { WagmiProvider } from 'wagmi'

import { createAppKit } from '@reown/appkit/react'
import { polygon, mainnet, zora, optimism, base, polygonMumbai, baseSepolia, arbitrum, morph } from '@reown/appkit/networks'
...
export const wagmiAdapter = new WagmiAdapter({
	...
	networks:
		ENVIRONMENT === 'production'
			? [base, mainnet, zora, optimism, arbitrum, polygon, storyMainnet, campNetworkTestnetV2, morph, solana]
			: [
					base,
					baseSepolia,
					zora,
