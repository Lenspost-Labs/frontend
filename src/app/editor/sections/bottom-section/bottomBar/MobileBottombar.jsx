...
import { Dialog, DialogBody, DialogHeader, Drawer, Tab, TabPanel, Tabs, TabsBody, TabsHeader } from '@material-tailwind/react'
import UploadSection, { UploadPanel } from '../../left-section/upload/UploadSection'
			...
			<div className="bg-[#F8F8F8]">
				<div className="flex justify-between align-middle mx-6 my-2 z-[999999]">
					<div
						...
						className={`${curOpenedPanel === 'mobPanelUpload' ? 'bg-[#e1f16b]' : ''} p-1 rounded-lg`}
					>
						<ImagePlus size={24} />
					</div>
					<div
						...
						className={`${curOpenedPanel === 'mobPanelText' ? 'bg-[#e1f16b]' : ''} p-1 rounded-lg`}
					>
						<TypeOutline size={24} />
					</div>
					<div
						...
						className={`${curOpenedPanel === 'mobPanelStickers' ? 'bg-[#e1f16b]' : ''} p-1 rounded-lg`}
					>
						<Sticker size={24} />
					</div>
					<div
