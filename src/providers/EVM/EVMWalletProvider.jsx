...
import { polygon, mainnet, zora, optimism, base, polygonMumbai, baseSepolia, arbitrum, degen, morph } from '@reown/appkit/networks'
...
export const wagmiAdapter = new WagmiAdapter({
	...
	networks:
		ENVIRONMENT === 'production'
			? [base, mainnet, zora, optimism, arbitrum, polygon, degen, ham, og, storyAeneidTestnet, morph, solana, campNetworkTestnetV2]
			: [
					base,
					baseSepolia,
					zora,
...
export const appKit = createAppKit({
	...
	networks:
		ENVIRONMENT === 'production'
			? [base, mainnet, zora, optimism, arbitrum, polygon, degen, ham, og, solana, storyAeneidTestnet, morph, campNetworkTestnetV2]
			: [
					base,
					baseSepolia,
					zora,
